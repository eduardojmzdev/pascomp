...
/**
 * Clase que engloba las distintas clases que componen los metodos de analisis
 * del lenguaje fuente de nuestro compilador.<br>
 * Representa las distintas caracteristicas de nuestra clase token (categoria
 * lexica) de los con las que se componen la estructura lexica del lenguaje
 * fuente
 * 
