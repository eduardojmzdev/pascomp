...
/**
 * Es una plantilla generica para tablas de simbolos de lenguajes de
 * programacion
 * 
 * @since jdk 1.6
 */
public abstract class AbstractSimbolTable<T> {
	...
	/**
	 * Mantiene las tablas de simbolos de los distintos ambientes de
	 * referenciamiento. Por ejemplo: Al entrar a un procedimiento P se inserta
	 * una nueva tabla para P donde mantiene sus datos locales. Si un
	 * identificador no esta en la tabla actual (ej: variable global), entonces
	 * se busca en las restantes tablas.
	 */
	protected LinkedList<Hashtable<String, T>> pila = null;

	/**
	 * Tabla de simbolos del ambiente de referenciamiento actual.
	 */
	...
	/**
	 * Inicializa la tabla de simbolos global con los tipos , funciones y
	 * constantes predefinidas que son propias del lenguaje. Las subclases deben
	 * implementarlo
	 */
	...
	/**
	 * Inserta en el tope de la pila una nueva tabla correspondiente a un nuevo
	...
	/**
	 * Elimina la tabla del tope de la pila y restaura el nivel actual.
	 */
