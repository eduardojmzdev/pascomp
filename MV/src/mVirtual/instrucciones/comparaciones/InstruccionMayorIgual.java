...
/**
 * 
 * Esta clase implementa la ejecución en la pila de la instrucción mayor o igual de la máquina virtual
 *
 */
public class InstruccionMayorIgual implements Instruccion {
