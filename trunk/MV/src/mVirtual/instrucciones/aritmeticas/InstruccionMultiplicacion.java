...
/**
 * 
 * Esta clase implementa la ejecución en la pila de la instrucción multiplicación de la máquina virtual
 *
 */
public class InstruccionMultiplicacion implements Instruccion {
