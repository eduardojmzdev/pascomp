...
/*    /**
     ...
     */
/*    public MVException(int codigo, int numLinea) {
        super("[MV] Error en linea " + numLinea + ": " + errorMap.get(new Integer(codigo)));
        this.codigo = codigo;
    }
     ...
     * @aram numLinea numero de linea donde ocurrio el error
     */
/*    public MVException(int codigo,String txt, int numLinea) {
        super("[MV] Error en linea "+numLinea+": '"+txt+"' "+errorMap.get(new Integer(codigo)));
        this.codigo = codigo;
    }
*/
