 ...
 * deben redefinir el metodo <code>run</code> con el codigo propio del test. Por
 * ejemplo, la clases AnalizadorLexico y AnalizadorSintactico implementan esta
 * interface para poder ser testeadas por el testeador
 * 
 *@see Testeador
 */
