...
/**
 * Permite realizar el testing de uno o mas archivos automaticamente.
 * Debe especificarse  la clase <code>Testeable</code> como argumento.
 * Para testear varios archivos se debe pasar como parametro el path o ruta
 * del directorio que los contiene.
 * Si no se especifican argumentos, se buscan archivos .pas a partir del
 * directorio actual.
 * <br><b>Ejemplo:</b>
 *<pre>
...
public final class Testeador {
     ...
     * @param file el nombre de archivo o directorio con
     *              los archivos fuentes.
     * @param test el objeto a testear
     */
    ...
    public void start() {
        if(!file.exists()){
            System.out.println("No existe ningun archivo o directorio con el nombre "+file.getName());
            return;
        }
    ...
    /**
     * Testea todos los archivos validos del directorio y subdirectorios
     * de <code>dir</code>
     *
     * @param dir el nombre del directorio con los archivos a testear
     */
     ...
     * dado como parametro
     *
     * @param file el archivo .pas o .txt a testear
     */
    private void testear(String file){
        ...
        if(!test.validaExtencion(file)){
            System.out.println("El archivo no tiene la extencion adecuada");
            return;
        }
        ...
        try{
            ...
            test.finish();
            System.out.printf("End Testing. Time: %f mseg %n",(double)(t2-t1)/1000000);
    ...
    /**
     * Main
     * @param args "clase Testeable" ["path o archivo a testear"]
     */
        ...
        if(args.length==1 || args.length==2) {
            ...
            try {
                ...
                if(ob instanceof Testeable)
                    ...
                    System.out.printf("La clase '%s' no implementa la interface Testeable!",args[0]);
                    return;
                }
            } 
            catch(Exception ex){
            ...
            Testeador t = new Testeador((args.length==2)?args[1]:".",test);
            t.start();
        } else{
            System.out.println("Modo de uso: java main.Testeador <clase Testeable> [<dir> | <file>]"+
                    "\nParametros:"+
