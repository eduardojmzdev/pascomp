...
public class MepaException extends BasicException {
	...
	static {
		...
		errorMap.put(new Integer(8),
				"Despues de PARA no pueden haber sentencias!");
		errorMap.put(new Integer(9), "Existen etiquetas sin declarar!");
		errorMap.put(new Integer(10), "El programa debe terminar con PARA");
		errorMap.put(new Integer(11),
				"La instruccion INPP solo puede ir al comienzo");
		errorMap.put(new Integer(12), "Argumentos invalidos!");
		errorMap.put(new Integer(13),
				"Entre dos etiquetas debe ir instruccion!");
		errorMap.put(new Integer(14), "Comienzo de instruccion invalida");
		errorMap.put(new Integer(15),
				"se espera un nro no negativo como primer argumento");
		errorMap.put(new Integer(16),
				"se espera una etiqueta como primer argumento.");
		errorMap.put(new Integer(17),
				"se espera una coma entre primer y 2do argumento");
		errorMap.put(new Integer(18),
				"se espera un nro no negativo como 2do argumento");
		errorMap.put(new Integer(19), "se espera una coma entre 2do y 3er arg");
		errorMap.put(new Integer(20),
				"se espera un nro no negativo como 3er argumento");
		errorMap.put(new Integer(21),
				"se espera un numero positivo  o negativo");
		...
		errorMap.put(new Integer(26),
				"Magnitud no representable ingresada por teclado.");
		errorMap.put(new Integer(27), "Desborde de Pila");
		errorMap.put(new Integer(28),
				"Recursos insuficientes para ejecutar el programa");
	}
	...
	public MepaException(int codigo, int numLinea) {
		super("[MEPA] Error en linea " + numLinea + ": "
				+ errorMap.get(new Integer(codigo)));
		this.codigo = codigo;
	}
	...
	public MepaException(int codigo, String txt, int numLinea) {
		super("[MEPA] Error en linea " + numLinea + ": '" + txt + "' "
				+ errorMap.get(new Integer(codigo)));
		this.codigo = codigo;
	}
}
