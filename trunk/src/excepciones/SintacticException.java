...
public final class SintacticException extends BasicException {
	...
	/**
	 * ESPECIFICACION DE INFORME DE ERRORES Formato: [CODIGO, MENSAJE]
	 */
	static {
		...
		errorMap
				.put(
						new Integer(5),
						"Se espera alguna de las sig. palabras reservadas: const,type,var,procedure,function o begin");
		errorMap
				.put(
						new Integer(6),
						"Se espera un identificador de tipo o  alguna de las siguientes palabras reservadas: var,procedure,function o begin");

		errorMap.put(new Integer(7),
				"se espera un numero o identificador de constante");
		errorMap
				.put(
						new Integer(8),
						"Se espera un identificador de constante o  alguna de las siguientes palabras reservadas: type,var,procedure,function o begin");
		errorMap.put(new Integer(9), "identificador de tipo invalido");
		errorMap
				.put(new Integer(10),
						"Se espera un identificador o constructor  de tipo Simple valido");
		...
		errorMap
				.put(
						new Integer(16),
						"Se espera un identificador de variable o  alguna de las siguientes palabras reservadas: procedure,function o begin");
		// errorMap.put(new Integer(17),"Se espera  una coma  ','");
		errorMap.put(new Integer(18), "Se espera  un  ')'");
		errorMap.put(new Integer(19),
				"Se espera ';' o falta la lista de parametros formales.");
		...
		errorMap.put(new Integer(22),
				"Identificador de tipo de retorno invalido");
		errorMap.put(new Integer(23),
				"Se espera ':', '(' o la lista de parametros formales .");
		...
		errorMap.put(new Integer(30), "Se espera un 'do'");
		errorMap.put(new Integer(31), "Se espera un 'while'");
		errorMap.put(new Integer(32), "Se espera una  expresion ");
