...
/**
 * TokenMepa Representa a un componente lexico del lenguaje
 */
public final class TokenMepa {
	...
	/** HashMap de lexemas */
	private static java.util.HashMap<Integer, String> LEXEMAS = new java.util.HashMap<Integer, String>(
			54);
	...
	private static final String instrucciones[] = { "APCT", "SUMA", "SUST",
			"MULT", "DIVI", "MODU", "UMEN", "CONJ", "DISJ", "NEGA", "CMME",
			"CMMA", "CMIG", "CMDG", "CMNI", "CMYI", "DUPT", "DSVS", "DSVF",
			"LEER", "IMPR", "LELN", "IMLN", "APVL", "ALVL", "INPP", "ENPR",
			"LLPR", "RMEM", "LMEM", "RTPR", "APDR", "APVI", "ALVI", "APAR",
			"ALAR", "PUAR", "POAR", "APAI", "ALAI", "PUAI", "POAI", "APDC",
			"CONT", "DIVC", "NADA", "PARA", "DSVV", "ALDR", "IMLV" };
	...
	public static Integer getCodigoInstruccion(String inst) {
		for (int i = 0; i < instrucciones.length; i++) {
			if (instrucciones[i].equals(inst))
