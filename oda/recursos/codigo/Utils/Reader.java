...
/**
 * Permite crear Objetos que leen caracteres desde diferentes fuentes, por
 * ejemplo un archivo, un String en memoria, un cinta, cd-room, etc.. Un ejemplo
 * de Reader es la clase <code>BufferedFileReader</code> usada por el
